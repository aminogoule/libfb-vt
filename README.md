...
`vim`, `htop`, …), включившие мышь сами, увидят клики как обычно.
...
показ/скрытие курсора (DEC `?25`), заголовки окна (OSC `0`/`2`), отчёты мыши (DECSET
`1000`/`1002`/`1006`, см. раздел «Мышь» выше). Достаточно для интерактивного shell;
это не полный xterm (нет прокручиваемых регионов).
